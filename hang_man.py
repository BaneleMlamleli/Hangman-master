...
while True:
    ...
    difficulty = input("What difficulty would you like to play on: Easy, Medium, or Hard? ").lower()
    ...
    if difficulty == "easy":
        ...
        print("easy level word: ", word)
    elif difficulty == "medium":
        word = random.choice(medium_word_list)
        print("medium level word: ", word)
    elif difficulty == "hard":
        word = random.choice(hard_word_list)
        print("hard level word: ", word)
